...
public class Scene
{
	...
	public Scene()
	{
		...
		m_cameras.add(new Camera(new Vec3f(0.0f, 2.5f, 11.0f), new Vec3f(0.0f, 0.0f, -1.0f), new Vec3f(0.0f, 1.0f, 0.0f)));
		...
		Material mat_cyan = new Material(new Vec3f(0.0f), new Vec3f(0.0f, 1.0f, 1.0f), 1.0f, 0.0f, 0.0f, 0.0f);
		...
		Material mat_white_light = new Material(Vec3f.scale(new Vec3f(1.0f), 4.0f), new Vec3f());
		...
		Primitive sphere_2 = new Sphere(new Vec3f(-2.0f, 2.5f, 3.0f), 0.5f);
		...
		Primitive wall_1 = new Plane(new Vec3f(0.0f, 0.0f, 12.0f), new Vec3f(0.0f, 0.0f, -1.0f));
